...
class TestArgs:
    def __init__(self, tcp_action):
        ...
        self.attach_func_info = {
            "fib_table_lookup": {
                ...
                "c_start_function": "deal_fib_table_lookup",
            }
        }
        self.attach_probes()
    ...
    def attach_probes(self):
        ...
        if attach_info["type"] == "kprobe":
            ...
            if "c_end_function" in attach_info.keys():
...
def trace(tcp_action="fib_table_lookup"):
    tt = TestArgs(tcp_action)
    tt.start()
